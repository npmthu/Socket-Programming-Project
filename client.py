...
def upload_folder(client_socket, folder_path, save_path):
    """
...
if __name__ == "__main__":
    ...
    if client_socket:
        try:
            #download_folder(client_socket, 'test1', 'test1_1733080214')
            #upload_folder(client_socket, 'test1_1733080214/test2', 'test1')
            print(create_folder_structure('test1_1733080214/test1'))
            time.sleep(120)
        except Exception as e:
